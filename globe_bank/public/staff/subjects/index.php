...
<?php
  $subjects_set = find_all_subjects(['visible' => false]); 
//   $subjects = [
 ...
 <div id="content">
  <div class="subjects listing">
    ...
    <div class="actions">
      ...
      <?php //fetch individual rows as associative array
        ...
        <tr>
          ...
          <td><?php echo $subject['visible'] == 1 ? 'true' : 'false'; ?></td>
    	    ...
    	    <td><?php echo h(count_pages_by_subject_id($subject['id'], ['visible' => false]))?></td>
